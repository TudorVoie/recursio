...
function updateTimelineMax() { timelineBar.max = animationQueue.length; }
function updateTimelineUI() { timelineBar.value = queueIndex; timelineLabel.innerText = `${queueIndex} / ${animationQueue.length}`; }
